...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='theater',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='booking_system.TheaterOwner'),
        ),
        migrations.AddField(
            model_name='theater',
            name='seat_types',
            field=models.ManyToManyField(to='booking_system.SeatType'),
        ),
        migrations.AddField(
            model_name='seat',
            name='seat_type',
